...
describe('[Challenge] Puppet', function () {
  ...
  before(async function () {
    ...
    await this.token.approve(this.uniswapExchange.address, UNISWAP_INITIAL_TOKEN_RESERVE, { from: deployer })
  ...
  it('Exploit', async function () {
    ...
    await this.token.approve(this.uniswapExchange.address, ATTACKER_INITAL_TOKEN_BALANCE, { from: attacker })
